module.exports = {
    ...
    execute(client, message) {
        ...
        if (success) message.channel.send(`${client.emotes.success} - File d'attente mélangée **${client.player.getQueue(message).tracks.length}** song(s) !`);
    },
};