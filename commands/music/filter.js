module.exports = {
    ...
    aliases: [],
    category: 'Music',
    utilisation: '{!p}filter [filter name]',
    ...
    execute(client, message, args) {
        ...
        if (filtersUpdated[filterToUpdate]) message.channel.send(`${client.emotes.music} - J'**ajoute** le filtre à la musique, veuillez patienter... Remarque : plus la musique est longue, plus cela prendra de temps.`);
